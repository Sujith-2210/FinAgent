...
- Output must be structured JSON"""
    ...
    async def process(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        financial_context.get("credit_utilization")
        financial_context.get("savings_rate")
        financial_context.get("monthly_emi")
        asset_classes = financial_context.get("asset_classes", [])
        financial_context.get("loan_types", [])
